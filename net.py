...
def saveNet(filename, generator, optimizer_gen, discriminator, optimizer_disc, iterations, train_loss, val_loss):
  torch.save({
...
def loadNet(filename, generator, optimizer_gen, discriminator, optimizer_disc, device):
  try:
